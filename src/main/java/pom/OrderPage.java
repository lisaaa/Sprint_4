...
public class OrderPage {
    ...
    private final By orderPeriodDay = By.xpath(".//div[@role='option' and text()='сутки']" );
    private final By orderPeriod2Day = By.xpath(".//div[@role='option' and text()='двое суток']" );
    ...
    public OrderPage getOrderPeriod(String period) {
            ...
            if (period.equals("сутки")) {
                driver.findElement(orderPeriodDay).click();
            } else if (period.equals("двое суток")) {
                driver.findElement(orderPeriod2Day).click();
            }
