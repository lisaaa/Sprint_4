...
public class AccordionTest {
    ...
    @Parameterized.Parameters (name = "number = {0}, expectedText = {1}")
    ...
    public AccordionTest(int number,String expectedText){
    ...
    public void CheckAccordionText(){
        ...
        heading.get(number).click();
        WebElement p = panel.get(number);
        mainPage.scrollToElement(p);
        mainPage.waitForToBeVisible(p);
